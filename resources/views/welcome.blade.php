...
<head>
    ...
    <title>Laravel_TO_DO_LIST</title>
    ...
    <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl ">
        ...
        <div class="mb-6">
            <form action="/" method="POST" class="flex flex-col space-y-4">
                ...
                <textarea name="description" class="py-3 px-4 bg-gray-100 rounded-xl" placeholder="The todo description"></textarea>
                <button class="w-28 py-4 px-8 bg-green-500 text-while rounded-xl">Add</button>
            </form>
        </div>
